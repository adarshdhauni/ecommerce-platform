  ...
  return (
    <div className="col-span-full flex justify-center py-10 sm:py-14 animate-fadeIn">
      <div
        className={`
        relative
      w-full  ${!compact ? "max-w-[420px] py-10" : "max-w-[360px] py-6"}
        overflow-hidden
      rounded-[28px]
    ...
    `}
      ...
      "
        ...
        `}
          >
            <svg
              ...
              stroke="currentColor"
              strokeWidth="1.7"
              className="h-5 w-5 text-black/42"
            >
              <path
                strokeLinecap="round"
        ...
        `}
          >
            {hasFilters ? filtersTitle : emptyTitle}
          </p>
        ...
        "
          >
            {hasFilters ? filtersDescription : emptyDescription}
          </p>
          {hasFilters && (
            <button
              onClick={() => {
